...
| 项目名称 | [从代码提取] | [文件路径] |
| 编程语言 | [从代码提取] | [文件扩展名] |
| 构建工具 | [从代码提取] | [pom.xml/package.json] |
| 代码目录 | [从代码提取] | [目录结构] |

**技术栈清单**：
| 类型 | 框架/组件 | 版本 | 来源文件 | 使用范围 |
|------|-----------|------|----------|----------|
| 服务框架 | [从依赖提取] | [版本] | pom.xml:12 | 全局 |
| 数据库 | [从依赖提取] | [版本] | pom.xml:25 | 数据层 |
| 缓存 | [从依赖提取] | [版本] | pom.xml:30 | 缓存层 |
| 消息队列 | [从依赖提取] | [版本] | pom.xml:35 | 通信层 |
...
| 检查项 | 状态 | 问题描述 | 建议 |
|--------|------|----------|------|
| 版本合规 | ✅/⚠️/❌ | [如：Spring Boot 2.x 即将EOL] | [升级建议] |
| 依赖完整 | ✅/⚠️/❌ | [问题描述] | [改进建议] |
| 配置规范 | ✅/⚠️/❌ | [问题描述] | [改进建议] |
